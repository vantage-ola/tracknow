...
describe("API", () => {
  ...
  describe("fetchUser", () => {
    it("should fetch a user successfully", async () => {
      ...
      (
        localStorageMock.getItem as jest.MockedFunction<
          typeof localStorageMock.getItem
        >
  ...
  describe("loginUser", () => {
    ...
    it("should throw an error when login fails", async () => {
      ...
      await expect(
        API.loginUser({ username: "user1", password: "wrong" }),
  ...
  describe("CreateUser", () => {
    ...
    it("should throw an error when user creation fails", async () => {
      ...
      await expect(
        API.CreateUser({ username: "newuser", password: "password" }),
  ...
  describe("handleLaptimes", () => {
    ...
    it("should throw an error when creating laptime fails", async () => {
      ...
      await expect(
        API.handleLaptimes(1, {
          title: "new laptime",
          simracing: false,
          comment: "my racing moments",
        }),
      ).rejects.toThrow("Failed to create laptime");
    });
    ...
    it("should throw an error when fetching laptimes fails", async () => {
      ...
      await expect(API.handleLaptimes(1)).rejects.toThrow(
        "Failed to fetch Personal laptimes",
      );
    });
  });
  ...
  describe("fetchMyLaptime", () => {
    ...
    it("should throw an error when fetching personal laptime fails", async () => {
      ...
      await expect(API.fetchMyLaptime(1)).rejects.toThrow(
        "Failed to fetch Personal Laptime. Does not exist.",
      );
    });
  });
  ...
  describe("fetchAUserLaptime", () => {
    ...
    it("should throw an error when fetching a user's specific laptime fails", async () => {
      ...
      await expect(API.fetchAUserLaptime(1, 1)).rejects.toThrow(
        "Failed to fetch #1 laptime",
      );
    });
  });
  ...
  describe("EditUserProfile", () => {
    ...
    it("should throw an error when editing user profile fails", async () => {
      ...
      await expect(
        API.EditUserProfile(1, { username: "Updated User" }),
      ).rejects.toThrow("Failed to Edit User profile");
    });
  });
  ...
  describe("EditUserProfilePic", () => {
    it("should edit user profile picture successfully", async () => {
      const mockResponse = {
        id: 1,
        profile_picture_url: "new-profile-picture.jpg",
      };
      (global.fetch as jest.Mock).mockResolvedValueOnce({
        ok: true,
        json: async () => mockResponse,
      ...
      const result = await API.EditUserProfilePic(1, {
        profile_picture_url: "new-profile-picture.jpg",
      });
    ...
    it("should throw an error when editing user profile picture fails", async () => {
      ...
      await expect(
        API.EditUserProfilePic(1, {
          profile_picture_url: "new-profile-picture.jpg",
        }),
      ).rejects.toThrow("Failed to Edit User profile picture");
    });
  });
  ...
  describe("fetchUsersLaptimes", () => {
    ...
    it("should throw an error when fetching user's laptimes fails", async () => {
      ...
      await expect(API.fetchUsersLaptimes(1, 1)).rejects.toThrow(
        "Failed to fetch #1's laptimes!",
      );
    });
  });
  ...
  describe("fetchF1Teams", () => {
    ...
    it("should throw an error when fetching Formula 1 teams fails", async () => {
      ...
      await expect(API.fetchF1Teams()).rejects.toThrow(
        "Failed to get Formula 1 Team Standings",
      );
    });
  });
  ...
  describe("fetchF1Drivers", () => {
    ...
    it("should throw an error when fetching Formula 1 drivers fails", async () => {
      ...
      await expect(API.fetchF1Drivers()).rejects.toThrow(
        "Failed to get Formula 1 Driver Standings",
      );
    });
  });
});
