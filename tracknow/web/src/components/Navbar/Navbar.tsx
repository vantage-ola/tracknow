...
const NavbarWelcome = () => (
  <Box
    ...
    borderBottom={1}
    borderStyle={"solid"}
    borderColor={useColorModeValue("dark", "white")}
  >
    <Flex h={10} alignItems={"center"} justifyContent={"space-between"}>
      ...
      <Flex alignItems={"center"}>
        <Stack direction={"row"} spacing={4}>
          <Link variant={"navbarLink"} as={ReactRouterLink} to={"/create-user"}>
            signup
          </Link>
          <Link variant={"navbarLink"} as={ReactRouterLink} to={"/login"}>
            login
          </Link>
          ...
          <Stack direction={"row"} spacing={1}>
            ...
            <Menu>
              ...
              <MenuList alignItems={"center"}>
                ...
                <br />
                <MenuDivider />
                <MenuItem as={ReactRouterLink} to={`/user/${name}/my-moments`}>
                  My Moments
                </MenuItem>
                <MenuItem
                  as={ReactRouterLink}
                  to={`/user/${name}/account-settings`}
                >
                  Account Settings
                </MenuItem>
...
export const NavbarLoggedInLayout: React.FC<NavbarLoggedInLayout> = ({
  onOpen,
}) => {
