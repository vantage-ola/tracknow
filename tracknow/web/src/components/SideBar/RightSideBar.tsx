...
const RightSideBar = () => {
  const { fetchTeamStandings, fetchDriverStandings, teamColors } =
    useMotorsportData();
    ...
    <>
      ...
      {loading ? (
        ...
        <Tabs isFitted variant="soft-rounded" colorScheme={"whiteAlpha"}>
          <TabList>
            <Tab fontSize="sm" color={"grey"} py={1}>
              CONSTRUCTORS
            </Tab>
            <Tab fontSize="sm" color={"grey"} py={1}>
              DRIVERS
          ...
          <TabPanels>
            <TabPanel>
              ...
              >
                ...
                <Text width="130px" fontSize="10px">
                  Constructor
                </Text>
                <Text width="30px" fontSize="10px">
                  Points
                </Text>
              </Flex>
              ...
              {teamStandings.map((team) => (
                <Box key={team.Constructor.name}>
                  <Flex justifyContent="space-between" alignItems="flex-start">
                    ...
                    <Box width="110px">
                      <Text color={teamColors[team.Constructor.name]}>
            ...
            <TabPanel>
              ...
              >
                <Text fontSize="10px">Rank</Text>
                <Text width="120px" fontSize="10px">
                  Driver
                </Text>
                <Text width="30px" fontSize="10px">
                  Points
                ...
                <Box key={driver.Driver.familyName}>
                  ...
                  >
                    ...
                    <Box width="100px">
                      ...
                      <Text
                        color={teamColors[driver.Constructors[0].name]}
                        fontSize={"8px"}
                      >
