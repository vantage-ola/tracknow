      ...
      img.onload = async () => {
        if (img.width <= 1080 && img.height <= 1080) {
          ...
          toast({
            ...
            description:
              "Please upload an image that is 1080x1080 pixels or smaller.",
            status: "error",
            duration: 3000,
            isClosable: true,
          });
      ...
      <Card size={"lg"} maxW="600px">
        ...
        <CardBody>
          <Stack spacing={6}>
            <Center>
              <Stack>
                <Avatar size={"2xl"} src={profilePic}></Avatar>
                <input
                  type="file"
                  ref={fileInputRef}
                  style={{ display: "none" }}
            ...
            <Stack spacing={5}>
              <Box>
                ...
                >
                  ...
                  <FormErrorMessage
                    fontSize={"11px"}
                    color={usernameValid ? "green.500" : "red.500"}
                    mb={2}
                  >
              ...
              <Box>
                ...
                <FormControl isInvalid={password !== "" && !passwordValid}>
                  ...
                  <FormErrorMessage
                    fontSize={"11px"}
                    color={passwordValid ? "green.500" : "red.500"}
                    mb={2}
                  >
              ...
              <Box>
                <Stack spacing={3}>
                  ...
                  <CountryDropdown
                    value={nationality}
                    change={(e) => setNationality(e.target.value)}
                  />
                </Stack>
              </Box>
            </Stack>
