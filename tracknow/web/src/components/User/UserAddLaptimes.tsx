      ...
      <Card size={"lg"} maxW="600px">
        ...
        <CardBody>
          <Stack spacing="5">
            <HStack>
              ...
              >
                <option style={{ backgroundColor: "black" }} value="true">
                  Sim racing
                </option>
                <option style={{ backgroundColor: "black" }} value="false">
                  Real life
                </option>
              </Select>
              ...
              {simracing && (
                <SimracingTitles
                  value={platform}
                  change={(e) => setPlatform(e.target.value)}
                />
              )}
            </HStack>
          ...
          <Stack pt={4} spacing="3">
            ...
            <Box>
              ...
              <FormControl
                isInvalid={time && !timeRegex.test(time) ? true : undefined}
              >
                <Input
                  borderColor={"#323536"}
                  focusBorderColor="grey"
                  variant="flushed"
                  placeholder="6:54.554"
                  onChange={(e) => setTime(e.target.value)}
                  maxLength={10}
                />
                {time && !timeRegex.test(time) && (
                  <FormErrorMessage fontSize={"11px"}>
                    Please enter a valid laptime
        ...
        <Flex pr={5} mb={6} justifyContent={"flex-end"}>
          <Button
            ...
            cursor={
              title && comment && !isUploading ? "pointer" : "not-allowed"
            }
            isLoading={isLoading}
